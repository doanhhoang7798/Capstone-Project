...
<div class="mdk-drawer js-mdk-drawer" id="default-drawer" data-align="start" data-position="left"
	...
	<div class="mdk-drawer__content" style="">
		<div class="sidebar sidebar-dark sidebar-left bg-dark-gray ps" data-perfect-scrollbar="">
			<div class="d-flex align-items-center sidebar-p-a sidebar-account flex-shrink-0">
				<a class="flex d-flex align-items-center text-underline-0"> <span class="mr-3"> <img
							src="${pageContext.request.contextPath }/resources/${user.getImage()}"
							style="width: 46px; height: 46px;" />
					</span> <span class="flex d-flex flex-column"> <span class="sidebar-brand">${user.getFullname()
			...
			<ul class="sidebar-menu">
				<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="${pageContext.request.contextPath}/">
			...
			<div class="sidebar-block p-0">
				<ul class="sidebar-menu mt-0">
					...
					<li class="sidebar-menu-item"><a class="sidebar-menu-button"
							href="${pageContext.request.contextPath}/admin/list-user-block"> <i
								class="sidebar-menu-icon sidebar-menu-icon--left material-icons">queue_play_next</i>
							<span class="sidebar-menu-text">Bị khoá</span>
						</a></li>
					<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="student-course-purchase.html">
						</a></li>
			...
			<div class="sidebar-block p-0">
				<ul class="sidebar-menu mt-0">
					<li class="sidebar-menu-item active"><a class="sidebar-menu-button"
							href="${pageContext.request.contextPath}/admin/list-post"> <i
								class="sidebar-menu-icon sidebar-menu-icon--left material-icons">layers</i>
							<span class="sidebar-menu-text">Bài viết</span>
						</a></li>

					<li class="sidebar-menu-item"><a class="sidebar-menu-button"
							href="${pageContext.request.contextPath}/admin/list-post-block"> <i
			...
			<div class="sidebar-block p-0">
				<ul class="sidebar-menu mt-0">
					<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="admin-dashboard.html"> <i
								class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i>
							<span class="sidebar-menu-text"> Bình luận</span>
						</a></li>
					<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="admin-emails.html"> <i
								class="sidebar-menu-icon sidebar-menu-icon--left material-icons">email</i>
							<span class="sidebar-menu-text">Bị khoá</span>
						</a></li>
					<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="admin-chat.html"> <i
								class="sidebar-menu-icon sidebar-menu-icon--left material-icons">comment</i>
							<span class="sidebar-menu-text">Chat</span>
						</a></li>
					<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="admin-tickets.html"> <i
					...
					<li class="sidebar-menu-item"><a class="sidebar-menu-button" href="admin-trello.html"> <i
