						...
						<tr>
							...
							<td>
								<button class="btn btn-danger">
									<span class="menu-icon"><i class="fa fa-trash"></i></span>
								</button>

								<button class="btn btn-dark use-block" id="test"
									data-href="${pageContext.request.contextPath}/admin/list-user-block/${user_detail.id}"
									data-toggle="modal" data-target="#confirm-delete">
									<i class="fa fa-lock"></i>
								</button> <a class="btn btn-info"
								href="${pageContext.request.contextPath}/admin/edit-profile/${user_detail.id}">
