...
<body>
	<div class="limiter">
		<div class="container-login100"
			style="background-image: url('${pageContext.request.contextPath}/resources/images/signup.jpg');">
				...
				<form class="login100-form validate-form flex-sb flex-w"
					...
					<div class="wrap-input100 validate-input"
						...
						<input class="input100" type="tel"
							pattern="^(03|05|07|08|09)+([0-9]{8})" required name="phone"
							id="phone"> <span class="focus-input100"></span>
					</div>
					...
					<span class="txt2" style="color: #c33; margin-left: 14%;">
						*Mật khẩu phải gồm ít nhất 1 chữ in hóa, 1 chữ in thường và 1 chữ
						số</span>
					...
					<div class="wrap-input100 validate-input"
						...
						<input id="confirm_password" class="input100" type="password"
							type="email" required name="cf_password"> <span
					...
					<script>
						function validatePassword() {
							...
							if (phone.value.trim().length == 0) {
								phone
										.setCustomValidity("Số điện thoại không được bỏ trống.");
							} else if (phone.value.trim().length != 10) {
								phone
										.setCustomValidity("Số điện thoại phải gồm 10 chữ số");
							} else {
