...
<div id="bottom-wrap">
	<div id="bottom" class="clearfix">
		<div style="float: left; width: 50%;">
			...
			<p style="line-height: 1.7rem;">Lấy cảm hứng từ những món ăn ngon
				và phổ biến tại Việt Nam và nước ngoài. Yummy Website xin gửi tới
				các bạn công thức chế biến kèm video mình họa giúp mọi người có thể
				tự tay chế biến những món ăn ngon độc lạ cho gia đình và bạn bè!</p>
		</div>
		...
		<div style="float: right; width: 30%;">
			...
			<div style="line-height: 1.7rem; padding-left: 40px;">
				<div style="text-align: center;">
					<a><img style="vertical-align: middle;; margin-left: -164px;"
						class="flaticon"
				...
				<div style="text-align: center;">
					<a><img
						style="vertical-align: middle;; margin-left: -193px; margin-top: 4px;"
						class="flaticon"
...
<div id="footer-wrap">
	<div id="footer">
		<p class="copyright">Copyright © 2020, Yummy-PekopekoTeam Vietnam.
...
<script type='text/javascript'
	src='${pageContext.request.contextPath}/resources/static/js/jquery-migrate.min.js'></script>
<script type='text/javascript'
	src='${pageContext.request.contextPath}/resources/static/js/script.js'></script>
<script type='text/javascript'
	src='${pageContext.request.contextPath}/resources/static/js/nivo-slider/jquery.nivo.slider.js'></script>
