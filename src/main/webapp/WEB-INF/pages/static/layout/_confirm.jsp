	...
	<div class="modal-dialog show-profile"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p style="font-size: 20px; font-weight: 700;color: black; text-align: center;"> Xác nhận thay đổi thông
					tin người dùng? </p>
			</div>
...
<div class="modal-password">
	<div class="modal-dialog show-password"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p style="font-size: 20px; font-weight: 700;color: black; text-align: center;"> Xác nhận thay đổi mật
					khẩu ? </p>
			</div>
			<div class="modal-footer">
