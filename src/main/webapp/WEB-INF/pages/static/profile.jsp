...
<div class="vd_content clearfix">
	<div class="vd_content-section clearfix">
		<div class="row">
			<div class="col-sm-12">
				<div class="panel widget light-widget form-horizontal" style="border: outset">
					<div class="panel-heading no-title"></div>

					<div class="panel-body " style="padding: 30px 65px;">
						<form action="${pageContext.request.contextPath }/edit-profile" enctype="multipart/form-data"
							method="POST" id="form_profile">
							<div class="row">
								...
								<div class="col-sm-9">
										...
										<div class="col-sm-9 controls">
											<div class="row mgbt-xs-0">
												<div style="width: 27%; float: left; margin-left: 15px;">
													...
													<span class="vd_radio radio-info"> <input type="radio" value="1"
															id="rd_name" name="gender" /> <label for="optionsRadios3">
															Nam </label>
													</span> <span class="vd_radio radio-danger"> <input type="radio"
															value="0" id="rd_nu" name="gender" /> <label
												...
												<input value="${ user.getAge() }" style="width: 161px;" name="age"
													type="number" max="80" required placeholder="Tuổi" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9 controls">
											<div class="row mgbt-xs-0">
												<div class="col-xs-9">
													<input type="date" required value="${ user.getBirthday().trim()}"
									...
									<div class="form-group">
										...
										<div class="col-sm-9 controls">
											<div class="row mgbt-xs-0">
												<div class="col-xs-9">
													<textarea required name="bio" placeholder=" Mô tả-
													Giới thiệu bản thân " cols="56" rows="4">${ user.getBio() }</textarea>
												</div>
												<!-- col-xs-12 -->
									...
									<button type="submit" style="margin-left: 364px;" class="btn btn-primary">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-secondary save-close-pass">Huỷ </button>
						...
						<h3 class="mgbt-xs-15" style="margin-top: -26px; margin: 16px 0px;">Cài đặt tài
							khoản</h3>
						...
						<div class="form-group" style="margin-top: 19px">
							...
							<div class="col-sm-9 controls">
								<div class="row mgbt-xs-0">
									<div style="width: 27%; float: left; margin-left: 15px;">
										<input readonly type="text" placeholder="Email " value="${ user.getPhone() }">
									</div>
									<div>
										<label class="col-sm-3 control-label font"
									...
									<div style="float: left; width: 28%;">
										<input readonly type="text" placeholder="Email " value="${ user.getEmail() }">
									</div>
						...
						<form action="${pageContext.request.contextPath }/change-password" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-9 controls">
									<div class="row mgbt-xs-0">
										<div class="col-xs-9">
											<input id="password" name="password" minlength="8" maxlength="20" required
							...
							<div class="form-group">
								...
								<div class="col-sm-9 controls">
									<div class="row mgbt-xs-0">
										<div class="col-xs-9">
											<input id="confirm_password" type="password" minlength="8" maxlength="20"
												required class="width-40" placeholder="Mật khẩu" />
										</div>
										<!-- col-xs-12 -->
									</div>
									<!-- row -->
